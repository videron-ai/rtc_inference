...
TASK_MAP = {"1": "Put the red lego in the blue bowl","2": "Put all the legos on the table in the blue bowl","3":"Release the gripper and safely move the arm back to the rest position"}
